...
function MiniStat({ label, value, color }: { label: string; value: string | number; color: string }) {
  return (
    <div style={{
      textAlign: 'center', padding: '14px 10px', background: 'var(--bg3)',
      ...
      <div style={{
        fontSize: 10, color: 'var(--text3)', marginTop: 6, fontFamily: 'var(--font-mono)',
...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div style={{
      ...
      <span style={{
        fontSize: 12, color: 'var(--text)', fontFamily: 'var(--font-mono)', textAlign: 'right',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ marginTop: 10 }}>
                <span style={{
                  fontSize: 10, fontFamily: 'var(--font-mono)', padding: '2px 10px',
                  borderRadius: 4,
              ...
              {tenure(profile.ultimez_join_date) && (
                <div style={{ marginTop: 8, fontSize: 11, color: 'var(--text3)' }}>
                  <span style={{
                    fontFamily: 'var(--font-mono)', fontSize: 10, background: 'var(--bg3)',
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                ...
                <span style={{
                  ...
                  color: prodColor(avgProd)
                }}>{avgProd}%</span>
              </div>
              <div style={{ height: 8, background: 'var(--border)', borderRadius: 4, overflow: 'hidden' }}>
                <div style={{
                  width: `${avgProd}%`, height: '100%',
          ...
          <div style={{
            ...
            {[
              ...
              <div key={tier.label} style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{
                    fontSize: 12, fontWeight: tier.active ? 600 : 400,
                    color: tier.active ? tier.color : 'var(--text3)'
                  }}>{tier.label}</div>
